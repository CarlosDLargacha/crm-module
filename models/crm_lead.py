...
class CrmLeadLostReason(models.Model):
    ...
    lost_reason = fields.Text(string='Porqué', required=False)

class CrmLeadOnchangeStage(models.Model):
    _inherit = 'crm.lead'

    @api.onchange('stage_id')
    def _onchange_stage_id(self):
        if self.stage_id.name == 'Lost' and not self.lost_reason:
            raise ValidationError("Debe rellenar el campo 'Porqué' para marcar un lead como perdido.")